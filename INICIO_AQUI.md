...
|----------------|---------------------|
| **Comandos copy-paste executáveis** | [AGENT_INSTRUCTIONS.md](AGENT_INSTRUCTIONS.md) ⚡ **AGENTES COMECEM AQUI** |
...
| **Decisões de arquitetura (histórico)** | [docs/decisions/](docs/decisions/) |
