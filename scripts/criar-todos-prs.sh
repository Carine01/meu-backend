...
echo ""
echo -e "${CYAN}🤖 Orquestrador Automático:${NC}"
echo -e "   • Cada PR receberá automaticamente o comentário do orquestrador"
echo -e "   • Labels 'automation' serão aplicadas automaticamente"
echo -e "   • Veja docs/ORCHESTRATOR.md para mais detalhes"
echo ""
